...
<body id="login">
  <div class="login-logo">
    <a href="index.html"><img src="/p2p_project/backStyle/images/logo.png" alt=""/></a>
  </div>
  <h2 class="form-heading">Register</h2>
  <form class="form-signin app-cam" action="/p2p_project/backJsp/indexback.jsp">
      ...
      <div class="registration">
          Already Registered.
          <a class="" href="/p2p_project/backJsp/login.jsp">
              Login
          </a>
      </div>
  </form>
