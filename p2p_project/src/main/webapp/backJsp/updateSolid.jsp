			...
			<div class="graphs">
				<div class="widget_head">
					<div class="box-right-main">
						<h2>
							<span class="glyphicon glyphicon-play" style="margin-right: 5px"></span>产品详情
						</h2>
					</div>
				</div>
				<hr>
				...
				<div class="tablelist">
					<form class="form-group" name="form1"
						action="/p2p_project/product/updateSolid" id="form1" method="post">
						<!-- table1 开始 -------------------------------------------------------------------------------->
						<table class="table table-condensed" border="0">
							<tr class="text-center">
								...
								<input style="height: 30px; width: 260px;"
									type="text" name="name" value="${subject.name}"></td>
								<td width="10%">类 型：</td>
							...
							<tr class="text-center">
								...
								<td width="20%" align="left"><select
									style="height: 30px; width: 260px;" name="safeguard_way">
										...
										<option value="1" ${subject.safeguard_way==1?"selected":""}>银行监管</option>
								</select></td>
							</tr>
							<tr class="text-center">
								<td width="10%">年化收益(%)：</td>
								<td width="20%" align="left"><input
									style="height: 30px; width: 260px;" type="number"
									name="year_rate" value="${subject.year_rate}"></td>
							...
							<tr class="text-center">
								...
								<td width="20%" align="left"><input
									...
									value="${subject.period }"></td>
								<td width="10%">借款人姓名：</td>
								<td width="20%" align="left"><input
									style="height: 30px; width: 260px;" type="text"
									name="borrowername" value="${subject.borrowername }"></td>
							</tr>
							
							<tr class="text-center">
								<td width="10%">标的开始时间：</td>
								<td width="20%" align="left"><input
									style="height: 30px; width: 260px;" type="text" name="create_date"
									value="${subject.create_date }"></td>
								<td width="10%">总金额(元)：</td>
								<td width="20%" align="left"><input
									style="height: 30px; width: 260px;" type="text"
									name="amount" value="${subject.amount }"></td>
							</tr>
						</table>
