         ...
         <div class="content-box  mrg15B">
          <div class="content-box-wrapper text-center">
            ...
            <div class="status-badge mrg10A">
                <img class="img-circle" width="40" src="/p2p_project/backStyle/images/1.png" alt="">
                <div class="small-badge bg-red"></div>
            </div>
            <div class="status-badge mrg10A">
                <img class="img-circle" width="40" src="/p2p_project/backStyle/images/2.png" alt="">
                <div class="small-badge bg-orange"></div>
            </div>
            <div class="status-badge mrg10A">
                <img class="img-circle" width="40" src="/p2p_project/backStyle/images/3.png" alt="">
                <div class="small-badge bg-red"></div>
            </div>
            <div class="status-badge mrg10A">
                <img class="img-circle" width="40" src="/p2p_project/backStyle/images/4.png" alt="">
                <div class="small-badge bg-green1"></div>
            </div>
            <div class="status-badge mrg10A">
                <img class="img-circle" width="40" src="/p2p_project/backStyle/images/5.png" alt="">
                <div class="small-badge bg-orange"></div>
            </div>
            <div class="status-badge mrg10A">
                <img class="img-circle" width="40" src="/p2p_project/backStyle/images/1.png" alt="">
